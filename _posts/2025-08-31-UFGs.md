---
layout: post
title: Systematic Assessment Visualization
category: en
description: This page is designed to visualize the methodological clusters and their associated indicators.
...
// The CDATA wrapper has been removed to ensure compatibility with Markdown.
...
var tree_text = {name: "INPUT INDICATORS FOR SYSTEMATIC ASSESSMENT OF URBAN FOOD GARDEN", children:[
  {name: "Quantitative \nSustainability", children:[
    {name: "Resource Inputs (Materials & Energy)", children:[
      {name: "Infrastructure Materials"},
      {name: "Substrate & Grow Medias"},
      {name: "Fertilizers & Soil Amendmentst"},
      {name: "Water (tap water, irrigation)"},
      {name: "Energy (electricity, fuel, diesel)"},
      {name: "Pesticides & Herbicides"},
      {name: "Packaging Materials"},
      {name: "Other Inputs (seeds, earthworms)"},
    ]},
    {name: "Economic Inputs", children:[
      {name: "Operational Costs"},
      {name: "Capital Costs"},
      {name: "Land Rent / Value"},
    ]},
    {name: "System & Production Parameters", children:[
      {name: "Crop Type & Yield Data"},
      {name: "Life Cycle Stages"},
      {name: "Food Waste Ratios"},
    ]},
  ]},
  {name: "Spatial Planning \n& Optimization", children:[
    {name: "Spatial & Geographic Data", children:[
      {name: "Land Use / Land Cover"},
      {name: "Building Data"},
      {name: "Infrastructure Networks"},
      {name: "Terrain data"},
      {name: "Climate Data"},
      {name: "Proximity to Features"},
      {name: "Soil Properties"},
    ]},
    {name: "Socio-Economic & Demographic Data", children:[
      {name: "Population Data"},
      {name: "Economic Indicators"},
      {name: "Health & Vulnerability Indicators "},
      {name: "Social Indicators"},
    ]},
    {name: "Policy & Planning Scenarios", children:[
      {name: "Land-Use Scenarios"},
      {name: "Siting Criteria"},
      {name: "Development Goals & Constraints"},
      {name: "Budget / Resource Constraints"},
    ]},
  ]},
  {name: "Systems & Nexus \nModeling", children:[
        {name: "Resource Flow & Consumption Data", children:[
      {name: "Water Demand & Supply Data"},
      {name: "Energy Demand & Supply Data"},
      {name: "Food Demand & Supply Data"},
      {name: "Organic Waste Generation Rates"},
    ]},
    {name: "System Design & Operational Parameters", children:[
      {name: "Technology Specifications"},
      {name: "UA Parameters"},
      {name: "Agent Attributes"},
    ]},
    {name: "External Drivers & Scenarios", children:[
      {name: "Climate Change Projections"},
      {name: "Policy Scenarios"},
      {name: "Economic Scenarios (price inflation)"},
    ]},
    {name: "Biophysical & Ecological Models", children:[
      {name: "Plant Growth Models"},
      {name: "Evapotranspiration Models"},
      {name: "Hydrological Models"},
    ]},
  ]},
  {name: "Socio-Ecological \n& Community", children:[
    {name: "Participant & Community Demographics", children:[
      {name: "Socio-Economic Data)"},
      {name: "Gardener Experience & Skill Level"},
    ]},
    {name: "Social & Institutional Factors", children:[
      {name: "Participant Motivations"},
      {name: "Stakeholder Perceptions"},
      {name: "Governance Structures"},
      {name: "Social Networks & Cohesion"},
    ]},
    {name: "Livelihood Capitals", children:[
      {name: "Human Capital"},
      {name: "Social Capital"},
      {name: "Financial Capital"},
      {name: "Physical & Natural Capital"},
    ]},
    {name: "UA Site Characteristics", children:[
      {name: "Food Distribution Model"},
      {name: "Management Practices"},
      {name: "Site Typology"},
    ]},
  ]},
    {name: "Empirical \n& Field-Based", children:[
    {name: "Resource Inputs (Measured)", children:[
      {name: "Irrigation Water Volume"},
      {name: "Soil Amendments"},
      {name: "Fuel for Machinery"},
    ]},
    {name: "Biophysical Site Characteristics", children:[
      {name: "Site & Cultivated Area (m²)"},
      {name: "Soil Quality Metrics"},
      {name: "Floral & Vegetative Diversity"},
    ]},
    {name: "Human Activity", children:[
      {name: "Labor Hours"},
      {name: "Volunteer time"},
    ]},
  ]},
...
var generate = function(){
  ...
  for(var i = 0; i < num_categories; ++i){
      ...
      if (category.name === "Quantitative \nSustainability" ||
          category.name === "Systems & Nexus \nModeling"   ||
          category.name === "Empirical \n& Field-Based") {
      ...
      var attributes = [
          'style="text-anchor:', text_anchor, '; font-weight:bold; fill:', tree_colors[i % tree_colors.length], '" ',
